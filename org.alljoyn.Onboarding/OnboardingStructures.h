...
internal:
    ...
    static _Check_return_ int32 GetAllJoynMessageArg(_In_ alljoyn_msgarg argument, _In_ PCSTR signature, _Out_ org::alljoyn::Onboarding::OnboardingResult^* value)
    {
        UNREFERENCED_PARAMETER(signature);

        (*value) = ref new org::alljoyn::Onboarding::OnboardingResult();
    ...
    static _Check_return_ int32 SetAllJoynMessageArg(_In_ alljoyn_msgarg argument, _In_ PCSTR signature, _In_ org::alljoyn::Onboarding::OnboardingResult^ value)
    {
        UNREFERENCED_PARAMETER(signature);
