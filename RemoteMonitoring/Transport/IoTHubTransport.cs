...
namespace RemoteMonitoring.Transport
{
    ...
    public class IoTHubTransport : ITransport
    {
        ...
        private Client.DeviceClient _deviceClient;
        ...
        public void Open()
        {
            ...
            _deviceClient = Client.DeviceClient.CreateFromConnectionString(GetConnectionString());
        }
        ...
        private string GetConnectionString()
        {
            ...
            var authMethod = new Client.DeviceAuthenticationWithRegistrySymmetricKey(deviceID, key);
