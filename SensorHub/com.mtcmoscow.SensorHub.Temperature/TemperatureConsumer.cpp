...
IAsyncOperation<TemperatureSetCelsiusResult^>^ TemperatureConsumer::SetCelsiusAsync(_In_ double value)
{
    return create_async([this, value]() -> TemperatureSetCelsiusResult^
    {
        ...
        if (ER_OK == status)
        {
            return TemperatureSetCelsiusResult::CreateSuccessResult();
        }
        return TemperatureSetCelsiusResult::CreateFailureResult(static_cast<int>(status));
    });
}
...
IAsyncOperation<TemperatureSetFahrenheitsResult^>^ TemperatureConsumer::SetFahrenheitsAsync(_In_ double value)
{
    return create_async([this, value]() -> TemperatureSetFahrenheitsResult^
    {
        ...
        if (ER_OK == status)
        {
            return TemperatureSetFahrenheitsResult::CreateSuccessResult();
        }
        return TemperatureSetFahrenheitsResult::CreateFailureResult(static_cast<int>(status));
    });
}
