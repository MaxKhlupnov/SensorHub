...
IAsyncOperation<PressureSetAltitudeResult^>^ PressureConsumer::SetAltitudeAsync(_In_ double value)
{
    return create_async([this, value]() -> PressureSetAltitudeResult^
    {
        ...
        if (ER_OK == status)
        {
            return PressureSetAltitudeResult::CreateSuccessResult();
        }
        return PressureSetAltitudeResult::CreateFailureResult(static_cast<int>(status));
    });
}
...
IAsyncOperation<PressureSetInchesOfMercuryResult^>^ PressureConsumer::SetInchesOfMercuryAsync(_In_ double value)
{
    return create_async([this, value]() -> PressureSetInchesOfMercuryResult^
    {
        ...
        if (ER_OK == status)
        {
            return PressureSetInchesOfMercuryResult::CreateSuccessResult();
        }
        return PressureSetInchesOfMercuryResult::CreateFailureResult(static_cast<int>(status));
    });
}
...
IAsyncOperation<PressureSetMmOfMercuryResult^>^ PressureConsumer::SetMmOfMercuryAsync(_In_ double value)
{
    return create_async([this, value]() -> PressureSetMmOfMercuryResult^
    {
        ...
        if (ER_OK == status)
        {
            return PressureSetMmOfMercuryResult::CreateSuccessResult();
        }
        return PressureSetMmOfMercuryResult::CreateFailureResult(static_cast<int>(status));
    });
}
...
IAsyncOperation<PressureSetPascalResult^>^ PressureConsumer::SetPascalAsync(_In_ double value)
{
    return create_async([this, value]() -> PressureSetPascalResult^
    {
        ...
        if (ER_OK == status)
        {
            return PressureSetPascalResult::CreateSuccessResult();
        }
        return PressureSetPascalResult::CreateFailureResult(static_cast<int>(status));
    });
}
