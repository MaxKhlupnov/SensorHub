...
public:
    ...
    virtual Windows::Foundation::IAsyncOperation<ConfigGetConfigurationsResult^>^ GetConfigurationsAsync(_In_ Windows::Devices::AllJoyn::AllJoynMessageInfo^ info, _In_ Platform::String^ interfaceMemberLanguageTag);
    virtual Windows::Foundation::IAsyncOperation<ConfigResetConfigurationsResult^>^ ResetConfigurationsAsync(_In_ Windows::Devices::AllJoyn::AllJoynMessageInfo^ info, _In_ Platform::String^ interfaceMemberLanguageTag, _In_ Windows::Foundation::Collections::IVectorView<Platform::String^>^ interfaceMemberFieldList);
    ...
    virtual Windows::Foundation::IAsyncOperation<ConfigSetPasscodeResult^>^ SetPasscodeAsync(_In_ Windows::Devices::AllJoyn::AllJoynMessageInfo^ info, _In_ Platform::String^ interfaceMemberDaemonRealm, _In_ Windows::Foundation::Collections::IVectorView<byte>^ interfaceMemberNewPasscode);
    virtual Windows::Foundation::IAsyncOperation<ConfigUpdateConfigurationsResult^>^ UpdateConfigurationsAsync(_In_ Windows::Devices::AllJoyn::AllJoynMessageInfo^ info, _In_ Platform::String^ interfaceMemberLanguageTag, _In_ Windows::Foundation::Collections::IMapView<Platform::String^,Platform::Object^>^ interfaceMemberConfigMap);
